      ...
      >
        ...
        {canGoPrev && (
          <motion.button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white/80 hover:text-white transition-colors"
            aria-label="Previous"
          >
        ...
        {canGoNext && (
          <motion.button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white/80 hover:text-white transition-colors"
            aria-label="Next"
          >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={onClose}
          className="absolute top-4 right-4 z-20 p-3 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white/80 hover:text-white transition-colors"
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          {/* Image Area - Full width on mobile, 60% on desktop */}
          <div
            className="flex-1 lg:flex-[1.5] flex items-center justify-center p-4 lg:p-8 relative overflow-hidden"
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-1 bg-black/50 backdrop-blur-sm rounded-full p-1"
            >
              <motion.button
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
            ...
            {zoomLevel > 1 && !isDragging && (
              <motion.p
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="absolute bottom-16 lg:bottom-20 left-1/2 -translate-x-1/2 text-xs text-white/40"
              >
          ...
          <motion.div
            ...
            className="lg:w-[320px] xl:w-[380px] bg-neutral-900/95 backdrop-blur-sm p-6 lg:p-8 overflow-y-auto max-h-[30vh] lg:max-h-none"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Category Badge */}
            {item.type && (
